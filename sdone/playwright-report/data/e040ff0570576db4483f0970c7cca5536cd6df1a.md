...
- Name: panels.test.ts >> Panels >> [P1] deselecting stock clears analytics
- Location: e2e\panels.test.ts:116:3
...
Call log:
  ...
  - waiting for locator('.analytics-panel__data')
    13 × locator resolved to <div class="analytics-panel__data">…</div>
