...
- Name: keyboard-shortcuts.test.ts >> Keyboard Shortcuts >> [P2] Tab cycles through modules when modules exist
- Location: e2e\keyboard-shortcuts.test.ts:124:3
...
Call log:
  ...
  - waiting for locator('.analytics-panel__data')
    15 × locator resolved to <div class="analytics-panel__data">…</div>
