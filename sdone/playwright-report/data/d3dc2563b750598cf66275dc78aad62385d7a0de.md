...
- Name: module-lifecycle.test.ts >> Module Lifecycle >> [P1] module can be dragged to a new position
- Location: e2e\module-lifecycle.test.ts:163:3
...
Call log:
  ...
  - waiting for locator('.countdown-panel__list')
    7 × locator resolved to <div class="countdown-panel__list"></div>
