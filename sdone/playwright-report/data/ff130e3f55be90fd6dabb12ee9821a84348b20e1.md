...
- Name: connection-lifecycle.test.ts >> Connection Lifecycle >> [P1] Delete key removes selected connection
- Location: e2e\connection-lifecycle.test.ts:198:3
...
Call log:
  ...
  - waiting for locator('.rate-editor__form')
    14 × locator resolved to <div class="rate-editor__form">…</div>
