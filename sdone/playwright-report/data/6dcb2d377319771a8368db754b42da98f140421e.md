...
- Name: connection-lifecycle.test.ts >> Connection Lifecycle >> [P1] deselecting a connection clears the rate editor
- Location: e2e\connection-lifecycle.test.ts:157:3
...
Call log:
  ...
  - waiting for locator('.rate-editor__form')
    7 × locator resolved to <div class="rate-editor__form">…</div>
