...
- Name: connection-lifecycle.test.ts >> Connection Lifecycle >> [P1] edge-drag stock→sink creates a directed connection
- Location: e2e\connection-lifecycle.test.ts:56:3
