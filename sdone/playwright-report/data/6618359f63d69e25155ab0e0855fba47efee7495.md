...
- Name: keyboard-shortcuts.test.ts >> Keyboard Shortcuts >> [P2] shortcut guard — Space+pause NOT toggled while editing target
- Location: e2e\keyboard-shortcuts.test.ts:86:3
