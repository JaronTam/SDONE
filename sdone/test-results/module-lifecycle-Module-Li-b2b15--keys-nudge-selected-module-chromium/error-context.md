...
- Name: module-lifecycle.test.ts >> Module Lifecycle >> [P1] arrow keys nudge selected module
- Location: e2e\module-lifecycle.test.ts:176:3
...
Call log:
  ...
  - waiting for locator('.analytics-panel__data')
    9 × locator resolved to <div class="analytics-panel__data">…</div>
