...
- Name: simulation.test.ts >> Simulation Controls >> [P1] confirming reset closes modal and restores stock values
- Location: e2e\simulation.test.ts:107:3
...
```ts
  ...
  19  |   pressSpace,
  20  |   waitForSimTicks,
  21  |   getControlBarStatus,
  22  |   getSceneCanvas,
  23  |   expectModalVisible,
  24  |   expectToast,
  25  |   worldToScreen,
  26  |   SELECTORS,
  27  | } from './helpers.js';
  28  |
  29  | test.describe('Simulation Controls', () => {
  30  |   test.beforeEach(async ({ page }) => {
  31  |     await setupPage(page);
  32  |   });
  33  |
  34  |   // ── Run/Pause via Button ─────────────────────────────────────────
  35  |
  36  |   test('[P0] Run button starts simulation and changes state', async ({ page }) => {
  37  |     await clickRun(page);
  38  |
