...
- Name: panels.test.ts >> Panels >> [P1] selecting a stock shows analytics data
- Location: e2e\panels.test.ts:107:3
...
Call log:
  - waiting for locator('.module-panel') to be visible
    - locator resolved to visible <div class="module-panel">…</div>
