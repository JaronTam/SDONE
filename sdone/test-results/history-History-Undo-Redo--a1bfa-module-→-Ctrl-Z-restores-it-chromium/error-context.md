...
- Name: history.test.ts >> History (Undo/Redo) >> [P2] delete module → Ctrl+Z restores it
- Location: e2e\history.test.ts:68:3
...
Call log:
  ...
  - waiting for locator('.analytics-panel__data')
    16 × locator resolved to <div class="analytics-panel__data">…</div>
